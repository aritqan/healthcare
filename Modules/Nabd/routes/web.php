...
use Modules\Nabd\Http\Controllers\Admin\MedicalSpecialtyController;
...
// MedicalSpecialty Crud Section
Route::prefix('medical_specialties')->name('medical_specialties.')->controller(MedicalSpecialtyController::class)->group(function () {
    Route::get('list'                           , 'index')->name('index');
    Route::get('datatable'                      , 'datatable')->name('datatable');
    Route::get('ajax-list'                      , 'ajaxList')->name('ajaxList');
    Route::get('create'                         , 'create')->name('create');
