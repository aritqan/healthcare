...
class MedicalSpecialty extends BaseModel
{
    use Translatable, SoftDeletes, Disableable, HasFactory;

    // Start Properties

    const VIEW_PATH = 'medical_specialties';
    ...
    public function getModel(int $id, bool $withTrashed = false, bool $withDisabled = false) : MedicalSpecialty
    {
        $model = $this::query();
    ...
    public function getDataTable(array $data) : JsonResponse
    {
        ...
        if($this->shouldShowTrash($data, MedicalSpecialtyPermissions::VIEW_TRASH)) {
        ...
        return DataTables::of($model)
            ...
            ->addColumn('actions', function ($model) {
                ...
                return
                    app('customDataTable')
                    ->routePrefix('nabd.medical_specialties')
                    ->of($model, MedicalSpecialtyPermissions::PERMISSION_NAMESPACE)
